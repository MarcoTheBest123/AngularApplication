...
@Component({
  selector: 'app-laptop-preview',
  templateUrl: './laptop-preview.component.html',
  styleUrls: ['./laptop-preview.component.scss']
})
export class LaptopPreviewComponent implements OnInit {
  ...
  cup$ = this.gltfLoaderService.load('assets/laptop.glb');
